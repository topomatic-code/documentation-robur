...
![рис.3](_media/context_menu3.jpg)
...
При юстировке вершины имеется возможно фиксировать при расчете либо длину полукривой, либо радиус кривой, выбирая необходимое условие из соответствующего выпадающего списка. В зависимости от выбранного элемента будет доступно либо задание длины кривой, либо значение радиуса в соответствующем поле ввода.
...
**Фиксировать при расчете** - выберите один из параметров вершины профиля который необходимо фиксировать при изменении свойств данной вершины.