...
1. Выберите меню **Профиль - Проектировать профиль по поперечному уклону**, откроется диалоговое окно:
   ...
   ![рис.1](_media/projecting_transverse_slope.jpg)
   ...
   **Использовать профиль с другого подобъекта** - с помощью данной функции имеется возможность задать в качестве исходного профиля, профиль с другой модели. Для этого выберите кнопку **Обзор**, откроется диалоговое окно:
   ...
   ![рис.2](_media/projecting_transverse_slope2.jpg)
   ...
   **Поперечное превышение** - задается значение поперечного превышения относительно выбранного исходного профиля.

   {% note info %}

   Значение Поперечного превышения может быть использовано при проектировании верха бортового камня. Т.е. профиль будет запроектирован относительно исходного, а затем поднят или опущен на заданную величину.
...
2. Задайте необходимые параметры и нажмите **Ок**. В результате программа запроектирует текущий относительно выбранного исходного профиля с заданными параметрами.
