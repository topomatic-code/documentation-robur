# Определение высотного положения площадки по балансу объемов земляных работ
...
1. Выберите элемент меню **Задачи - Площадки - Площадки (Архив) - Сбалансировать площадку**.
2. Курсор примет форму прицела, левой кнопкой мыши укажите на плане исходный замкнутый контур, являющийся границей проектируемой площадки. Откроется диалоговое окно:
   ...
   ![рис.1](_media/definition_height_position_platforms_by_balance_volumes.jpg)
